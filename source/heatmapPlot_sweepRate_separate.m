...
intervalWidth = nan(numGridpoints^2, 4, length(rateIndices));
...
for i = 1:length(rateIndices)
    load(strcat(filePrefix,num2str(rateIndices(i)),'.mat'),'lowerBound','upperBound','MLE','trueVals','SIGMA_SET');
...
print(fig1, 'Figures_withDynamics/heatmap_sweepRate_intervalWidth_top.png', ...
      '-dpng', '-r300');
...
print(fig2, 'Figures_withDynamics/heatmap_sweepRate_intervalWidth_bottom.png', ...
      '-dpng', '-r300');
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepRate_mleRelative_top.png', ...
      '-dpng', '-r300');
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepRate_mleRelative_bottom.png', ...
      '-dpng', '-r300');
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepRate_mleAbsolute_top.png', ...
      '-dpng', '-r300');
...
t2 = tiledlayout(fig2, nRows_bottom, nCols, 'TileIndexing', 'columnMajor', 'TileSpacing','compact');
t2.Padding = t1.Padding;
t2.TileSpacing = t1.TileSpacing;
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepRate_mleAbsolute_bottom.png', ...
      '-dpng', '-r300');
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepRate_intervalDist_top.png', ...
      '-dpng', '-r300');
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepRate_intervalDist_bottom.png', ...
      '-dpng', '-r300');
...
% t.TileIndexing = "columnMajor";
% colormap(batlow)
% colours = crameri('batlow',length(rateIndices));
% mlLims_bottom = min(abs(mlEstimate - allTrueVals),[],'all');
% mlLims_top = abs(mlEstimate - allTrueVals);
% mlLims_top(mlLims_top == Inf) = 0;
% clims = [mlLims_bottom,...
