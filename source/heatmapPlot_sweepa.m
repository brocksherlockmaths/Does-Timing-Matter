...
print(fig1, 'Figures_withDynamics/heatmap_sweepa_intervalWidth_top.png', ...
      '-dpng', '-r300');

% === BOTTOM FIGURE ===
fig2 = figure(11);
fig2.Units = 'centimeters';
fig2.Position = [2, 2, figWidth_cm, figHeight_bottom_cm+2];
...
print(fig2, 'Figures_withDynamics/heatmap_sweepa_intervalWidth_bottom.png', ...
      '-dpng', '-r300');
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepa_mleAbsolute_top.png', ...
      '-dpng', '-r300');
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepa_mleAbsolute_bottom.png', ...
      '-dpng', '-r300');
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepa_intervalDist_top.png', ...
      '-dpng', '-r300');
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepa_intervalDist_bottom.png', ...
      '-dpng', '-r300');
