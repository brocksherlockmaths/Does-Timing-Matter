...
[r,c] = find(paramSpace(2,:) == 1 & paramSpace(3,:) == 0.1);
...
for j = 1:length(indices)
    for i = 1:(num_params-1)
        ...
        if i == 1
            title(strcat("$P(0) = ", num2str(a_range(j)),'$'));
        end
    end
end
...
% Axes font/line
set(findobj(fig1,'type','axes'), 'FontSize', 14, 'LineWidth', 1);

% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepa_smallSample_intervalWidth_top.png', ...
      '-dpng', '-r300');
...
print(fig2, 'Figures_withDynamics/heatmap_sweepa_smallSample_intervalWidth_bottom.png', ...
      '-dpng', '-r300');
...
for j = 1:length(indices)
    for i = 1:num_params
        ...
        if i == 1
            title(strcat("a = ",num2str(a_range(j))));
        end
    end
end
t.Title.String = 'MLE Estimate Relative Error';
t.XLabel.String = '\Delta';
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepa_smallSample_mleAbsolute_top.png', ...
      '-dpng', '-r300');
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepa_smallSample_mleAbsolute_bottom.png', ...
      '-dpng', '-r300');
...
% Export
set(fig1, 'PaperPositionMode', 'auto');
print(fig1, 'Figures_withDynamics/heatmap_sweepa_smallSample_intervalDist_top.png', ...
      '-dpng', '-r300');
...
% Export
set(fig2, 'PaperPositionMode', 'auto');
print(fig2, 'Figures_withDynamics/heatmap_sweepa_smallSample_intervalDist_bottom.png', ...
      '-dpng', '-r300');
